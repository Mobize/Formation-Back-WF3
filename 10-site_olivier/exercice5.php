...
<div class="form-group" action="">
  ...
  <input type="text" name="nom" class="form-control" id="exampleInputEmail1" placeholder="nom" value="<?= $conducteur['id_conducteur'] ?? '' ?>">
</div>
<div class="form-group">
  <label for="exampleInputPassword1">Prenom</label>
  <input type="text" name="prenom" class="form-control" id="exampleInputPassword1" placeholder="prenom" value="<?= $conducteur['id_vehicule'] ?? '' ?>">
</div>
